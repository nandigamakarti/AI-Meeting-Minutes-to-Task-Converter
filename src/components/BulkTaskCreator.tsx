...
export function BulkTaskCreator({ onTasksCreate }: BulkTaskCreatorProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-600 dark:text-slate-300">
          Transform any text into multiple actionable tasks
        </p>
      </div>
      ...
      <div className="relative">
        <Textarea
          ...
          placeholder="Paste your meeting transcript, notes, or any text with multiple tasks here..."
...
async function parseMeetingWithGemini(transcript: string, apiKey: string): Promise<ParsedMeetingTask[]> {
  const prompt = `
You are an intelligent text analyzer. Parse the following text and extract all actionable tasks. Return ONLY valid JSON with this exact structure:
